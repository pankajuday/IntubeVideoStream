...
const loginUser = asyncHandler(async (req, res) => {
    // get user details username and password -> req.body , from front-end
...
const getCurrentUser = asyncHandler(async (req, res) => {
    // const {username, avatar, coverImage} = req.user
...
const updateAccouteDetails = asyncHandler(async (req, res) => {
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    const publicUrl = req.user.avatar;
    const options = {
        resource_type: "image",
    };
    if (!avatarLocalPath) {
    ...
    const deletedAvt = await deleteFromCloudinary(publicUrl, options);
    // console.log("run", deletedAvt);
    const avatar = await uploadOnCloudinary(avatarLocalPath);

    // const avatar = await updateOnCloudinary(avatarLocalPath, publicUrl);
